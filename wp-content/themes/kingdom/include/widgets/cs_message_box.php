...

{
   ...
   public function __construct() {
			...
			parent::__construct(
			'princple_msg', // Base ID
			__( 'Chimps : Welcome Box',CSDOMAIN ), // Name
			array( 'classname' => 'princple-msg', 'description' =>__('Welcome box display beside slider',CSDOMAIN ) ) // Args
			);
		}
...
<?php _e('Number of Text',CSDOMAIN)?>

...
{ 
  public function __construct() {
			...
			__( 'Chimps : Facebook',CSDOMAIN ), // Name
			array( 'classname' => 'facebook_module', 'description' =>__('Facebook widget like box total customized with theme', CSDOMAIN ), ) // Args
			);
		}
...
?>
  ...
  <label for="<?php echo $this->get_field_id('pageurl'); ?>">
	...
	<br />
      <small> <?php _e('Please enter your page or User profile url example:',CSDOMAIN)?> http://www.facebook.com/profilename OR <br />
  ...
  <label for="<?php echo $this->get_field_id('likebox_height'); ?>">
	  <?php _e('Like Box Height',CSDOMAIN)?> 
	...
	<p>		
     <label for="<?php echo $this->get_field_id('fb_bg_color'); ?>">
     	 <?php _e('Background Color',CSDOMAIN)?> 
			...
			<div class="facebookOuter">
			 <div class="facebookInner">
			  <div class="fb-like-box" 
				  colorscheme ="light" data-width="250" data-height="<?php echo $likebox_height;?>" 
